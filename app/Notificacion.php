...
class Notificacion extends Model
{
    ...
    'PROVI_2','ADJ_APROBA','APROB_IMPO','ADJ_OFICIO','EMBARGO_N','EMB_FECHA','OTRA_INSTI','SALDO_LIQUI',
    'LIQUIDACIO','IMPORT_LIQUI','APROBA_AI','APRO_FECHA','HONO_MAS_IVA','NOTIFI_LIQUI','CON_DEPOSITO',
     ...
     'INHI_AI_NRO', 'INHI_AI_FEC', 'INHI_NRO', 'FEC_INIVI'
 ];

 /*
  'NOTIFI_4','SALDO_EXT',
    'NOTIFI_5','EMBAR_EJEC','SD_FINIQUI','FEC_FINIQU','INIVISION','FEC_INIVI','ARREGLO_EX','LEVANTA',
