...
<div class="form-group">
      ...
      <input   value="{{! isset($ficha6) ? '' : $ficha6->FECHA }}" name="FECHA"   type="text"     class="form-control form-control-sm   ">
</div> 
...
<div class="form-group">
      ...
      <input   value="{{! isset($ficha6) ? '' : $ficha6->NOTIFI_1 }}" name="NOTIFI_1"   type="text"     class="form-control form-control-sm   ">
</div> 
</div> 
...
<div class="form-group">
      ...
      <input   value="{{! isset($ficha6) ? '' : $ficha6->ADJ_CITA }}" name="ADJ_CITA"   type="text"     class="form-control form-control-sm   ">
</div> 
...
<div class="form-group">
      ...
      <input   value="{{! isset($ficha6) ? '' : $ficha6->NOTIFI_2 }}" name="NOTIFI_2"   type="text"     class="form-control form-control-sm   ">
</div> 

<div class="form-group">
      <label for="ctactecatas">Adj. S.D:</label>
      <input   value="{{! isset($ficha6) ? '' : $ficha6->ADJ_SD }}" name="ADJ_SD"   type="text"     class="form-control form-control-sm   ">
</div> 
...
<div class="form-group">
      <label for="ctactecatas">FECHA:</label>
      <input   value="{{! isset($ficha6) ? '' : $ficha6->FECHA_SD }}" name="FECHA_SD"   type="text"     class="form-control form-control-sm   ">
</div> 

<div class="form-group">
      <label for="ctactecatas">Notificación 3:</label>
      <input   value="{{! isset($ficha6) ? '' : $ficha6->NOTIFI_3 }}" name="NOTIFI_3"   type="text"     class="form-control form-control-sm   ">
</div> 
